...
#SBATCH -o sbatch_outputs/2D_blind_unet_%j.out  # %j inserts jobid
#SBATCH -e sbatch_outputs/2D_blind_unet_%j.err  # %j inserts jobid
source ~/modules/pytorch/latest
source ~/modules/nccl/nccl_2.9.8-1+cuda11.0_x86_64/source
PL_TORCH_DISTRIBUTED_BACKEND=nccl python train-lightning.py --config-file configs/2D/blind-denoising/unet.yaml
